...
class AdminAuthService {
  private static ACCESS_TOKEN_KEY = 'wlbj_admin_access_token';
  private static REFRESH_TOKEN_KEY = 'wlbj_admin_refresh_token';
  private static USER_KEY = 'wlbj_admin_user';
